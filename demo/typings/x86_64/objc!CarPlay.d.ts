...
declare class CPListSection extends NSObject implements NSSecureCoding {
	...
	constructor(o: { items: NSArray<CPListItem>; });

	constructor(o: { items: NSArray<CPListItem>; header: string; sectionIndexTitle: string; });

	encodeWithCoder(aCoder: NSCoder): void;

	initWithCoder(aDecoder: NSCoder): this;

	initWithItems(items: NSArray<CPListItem>): this;

	initWithItemsHeaderSectionIndexTitle(items: NSArray<CPListItem>, header: string, sectionIndexTitle: string): this;
}
