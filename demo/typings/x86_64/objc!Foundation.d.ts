...
declare class NSURLSessionConfiguration extends NSObject implements NSCopying {
	...
	static pn_HTTPAdditionalHeaders(): NSDictionary<string, any>;

	static pn_allowsCellularAccess(): boolean;

	static pn_connectionProxyDictionary(): NSDictionary<string, any>;

	static pn_networkServiceType(): NSURLRequestNetworkServiceType;

	static pn_protocolClasses(): NSArray<typeof NSObject>;

	static pn_setAllowsCellularAccess(allowsCellularAccess: boolean): void;

	static pn_setConnectionProxyDictionary(connectionProxyDictionary: NSDictionary<string, any>): void;

	static pn_setHTTPAdditionalHeaders(HTTPAdditionalHeaders: NSDictionary<string, any>): void;

	static pn_setNetworkServiceType(networkServiceType: NSURLRequestNetworkServiceType): void;

	static pn_setProtocolClasses(protocolClasses: NSArray<typeof NSObject>): void;
